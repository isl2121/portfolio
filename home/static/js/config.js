...
*******************************************************************/
		...
		*******************************************************************/
				...
				// IMAGE PATH / URL
				var option_hero_background_image_path = [{src:$('#back_img1').val()}];
		...
		*******************************************************************/
				...
				// USE CUSTOM COLOR - [ "on" : "off" ]
				
				// "on" = TEMPLATE WILL USE CUSTOM COLOR FROM BELOW
				// "off" = TEMPLATE WILL USE COLOR FORM CSS FILE TO FIT THE COLOR SCHEME
				
				var option_hero_background_color_custom = "off";
				
				
				// CUSTOM COLOR ( FORMAT: ALL CSS FORMATS )
				var option_hero_background_color_custom_color = "#4600FF";
		...
		*******************************************************************/
				...
				// MESH COLOR
				var option_hero_background_mesh_color = "#fff";
